                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
                    ...
                    <div className="flex-1 flex flex-col gap-6 items-start">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-tight">
                            Stop{" "}
                            <span className="text-brand">Tab-Switching</span>. One Command
                            Center.
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
                            ...
                            >
                                Request Access
                                <MaterialIcon name="arrow_forward" size="md" className="text-white" />
                            </Button>
                            <Button
                                variant="outline"
                                size="lg"
                            ...
                            >
                                <MaterialIcon name="play_circle" size="md" className="text-slate-900" />
                                Interactive Demo
                            </Button>
                        </div>
                        ...
                        <div className="bg-slate-200 border border-slate-300 rounded-lg p-2.5 shadow-2xl">
                            <div className="relative w-full aspect-[526/450]">
                                ...
                                <div className="absolute top-0 left-[68%] right-0 bottom-[55%] bg-brand-light border border-brand-muted rounded flex flex-col items-center justify-center gap-1.5">
                                    <MaterialIcon name="analytics" size="md" className="text-brand" />
