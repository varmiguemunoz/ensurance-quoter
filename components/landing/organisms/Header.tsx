            ...
            <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-10">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        <Button variant="ghost" size="sm" className="font-semibold text-slate-900">
                            Sign In
                        </Button>
                        <Button
                            size="sm"
                    ...
                    >
                        <MaterialIcon name={mobileMenuOpen ? "close" : "menu"} size="md" className="text-slate-900" />
                    </button>
                </div>
                ...
                >
                    <nav className="flex flex-col gap-4 pt-4" aria-label="Mobile navigation">
                        {NAV_LINKS.map((link) => (
                            <NavLink key={link.label} href={link.href} className="text-base py-2">
                                {link.label}
                            </NavLink>
                        ))}
                        <div className="flex flex-col gap-3 pt-4 border-t border-slate-200">
                            <Button variant="ghost" className="w-full justify-center font-semibold text-slate-900">
                                Sign In
                            </Button>
